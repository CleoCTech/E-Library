...
<main role="main" class="flex-shrink-0">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3 d-flex align-items-center form-group">
                    <div class="input-label-absolute input-label-absolute-right w-100">
                      ...
                      <input type="text" name="department" placeholder="Arts and Humanities" id="department" class="form-control border-0 shadow-0">
                    </div>
                  </div>
                  <div class="col-lg-3 d-flex align-items-center form-group no-divider">
                    ...
                    </select><button type="button" class="btn dropdown-toggle btn-form-control bs-placeholder" data-toggle="dropdown" role="combobox" aria-owns="bs-select-1" aria-haspopup="listbox" aria-expanded="false" title="Categories"><div class="filter-option"><div class="filter-option-inner"><div class="filter-option-inner-inner">Categories</div></div> </div></button><div class="dropdown-menu" style="max-height: 281.891px; overflow: hidden; min-height: 156px;"><div class="inner show" role="listbox" id="bs-select-1" tabindex="-1" style="max-height: 265.891px; overflow-y: auto; min-height: 140px;"><ul class="dropdown-menu inner show" role="presentation" style="margin-top: 0px; margin-bottom: 0px;"><li><a role="option" class="dropdown-item" id="bs-select-1-0" tabindex="0" aria-setsize="4" aria-posinset="1"><span class="text">Arts</span></a></li><li><a role="option" class="dropdown-item" id="bs-select-1-1" tabindex="0" aria-setsize="4" aria-posinset="2"><span class="text">Humanities</span></a></li><li><a role="option" class="dropdown-item" id="bs-select-1-2" tabindex="0" aria-setsize="4" aria-posinset="3"><span class="text">Social Science</span></a></li><li><a role="option" class="dropdown-item" id="bs-select-1-3" tabindex="0"><span class="text">Biological Science</span></a></li></ul></div></div></div>
                  </div>
                  <div class="col-lg-2">
  ...
  <section class="py-6">
    <div class="container">
        <div class="row mb-5">
            <div class="col md-12">
                <p class="subtitle text-secondary">Arts and Humanities</p>
                </br>
                <span class="badge badge-pill">Arts</span>
                <span class="badge badge-pill">Humanities</span>
                <span class="badge badge-pill">Social Science</span>
            </div>
        </div>
